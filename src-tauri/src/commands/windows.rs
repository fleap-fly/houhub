...
///
/// Only the pet panel calls this. A `houhub://` OS deep link cannot: the emit
...
mod settings_route_tests {
    ...
    /// page — where the houhub-mcp tool switches live in full — must be able to
