...
//! experts — `~/.houhub/skills/<id>/`. Users enable a science skill for any ACP
...
// ─── Paths ──────────────────────────────────────────────────────────────
// The central store is shared with experts (`~/.houhub/skills/`); only the
...
mod tests {
    ...
    async fn apply_links_does_not_deadlock() {
        let ops = vec![
            LinkOp {
                expert_id: "zzz-houhub-science-batch-absent-aaa".into(),
                agent_type: AgentType::ClaudeCode,
                enable: false,
            },
            LinkOp {
                expert_id: "zzz-houhub-science-batch-absent-bbb".into(),
    ...
    async fn apply_links_collects_per_op_results_without_aborting() {
        let ops = vec![
            LinkOp {
                expert_id: "zzz-houhub-science-batch-absent".into(),
                agent_type: AgentType::ClaudeCode,
                enable: false,
            },
            LinkOp {
