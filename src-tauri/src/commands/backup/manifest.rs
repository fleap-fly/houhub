...
//! self-describing whether or not they end up wrapped in the encrypted backup
//! envelope.
...
///
/// **2** — the archive gained the houhub-owned sections beyond `uploads`
...
/// version of houhub" refusal. Reading OLDER archives is unaffected; the gate
...
/// mistaken for an houhub backup. The value stays stable so existing
/// legacy backups remain restorable.
pub const BACKUP_KIND: &str = "houhub-backup";
...
pub struct BackupManifest {
    ...
    /// Which houhub-owned sections (see
...
pub struct BackupPreview {
    /// The archive is wrapped in the encrypted `.houhubbak` envelope.
    pub encrypted: bool,
