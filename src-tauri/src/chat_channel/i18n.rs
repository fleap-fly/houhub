...
pub fn permission_request_body(lang: Lang) -> &'static str {
    match lang {
        Lang::ZhCn => "智能体正在请求权限，请在 houhub 中查看并批准。",
        Lang::ZhTw => "智慧代理正在請求權限，請在 houhub 中查看並批准。",
        Lang::Ja => "エージェントが権限を要求しています。houhub で確認して承認してください。",
        Lang::Ko => "에이전트가 권한을 요청하고 있습니다. houhub에서 확인하고 승인하세요.",
        Lang::Es => "Un agente solicita permiso. Revísalo y apruébalo en houhub.",
        Lang::De => "Ein Agent fordert eine Berechtigung an. Bitte in houhub prüfen und genehmigen.",
        Lang::Fr => "Un agent demande une autorisation. Vérifiez-la et approuvez-la dans houhub.",
        Lang::Pt => "Um agente está solicitando permissão. Revise e aprove no houhub.",
        Lang::Ar => "يطلب أحد الوكلاء إذنًا. يرجى مراجعته والموافقة عليه في houhub.",
        Lang::En => "An agent is requesting permission. Review and approve it in houhub.",
    }
}
...
pub fn question_request_body(lang: Lang) -> &'static str {
    match lang {
        Lang::ZhCn => "智能体正在向你提问，请在 houhub 中回答。",
        Lang::ZhTw => "智慧代理正在向你提問，請在 houhub 中回答。",
        Lang::Ja => "エージェントが質問しています。houhub で回答してください。",
        Lang::Ko => "에이전트가 질문하고 있습니다. houhub에서 답변하세요.",
        Lang::Es => "Un agente te hace una pregunta. Respóndela en houhub.",
        Lang::De => "Ein Agent stellt eine Frage. Bitte in houhub beantworten.",
        Lang::Fr => "Un agent vous pose une question. Répondez-y dans houhub.",
        Lang::Pt => "Um agente está fazendo uma pergunta. Responda no houhub.",
        Lang::Ar => "يطرح أحد الوكلاء سؤالاً. يرجى الإجابة عليه في houhub.",
        Lang::En => "An agent is asking a question. Answer it in houhub.",
    }
}
...
pub fn help_title(lang: Lang) -> &'static str {
    match lang {
        Lang::ZhCn => "houhub Bot 帮助",
        Lang::ZhTw => "houhub Bot 幫助",
        Lang::Ja => "houhub Bot ヘルプ",
        Lang::Ko => "houhub Bot 도움말",
        Lang::Es => "Ayuda de houhub Bot",
        Lang::De => "houhub Bot Hilfe",
        Lang::Fr => "Aide houhub Bot",
        Lang::Pt => "Ajuda do houhub Bot",
        Lang::Ar => "مساعدة houhub Bot",
        Lang::En => "houhub Bot Help",
    }
}
