...
pub const ENV_SUPERVISED: &str = "HOUHUB_SUPERVISED";
...
pub const ENV_RESTART_DELAY_MS: &str = "HOUHUB_RESTART_DELAY_MS";
...
pub const ENV_RUNTIME: &str = "HOUHUB_RUNTIME";

/// Default relaunch delay when `HOUHUB_RESTART_DELAY_MS` is unset.
...
pub const ENV_UPGRADE_TRIAL_SECS: &str = "HOUHUB_UPGRADE_TRIAL_SECS";

/// Default trial window when `HOUHUB_UPGRADE_TRIAL_SECS` is unset. A binary
