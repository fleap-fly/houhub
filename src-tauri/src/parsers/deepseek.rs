...
/// mirrored, because that cwd is the session workspace, not houhub's, so
...
/// malformed by that rule; houhub prefers the Zstandard set because
    ...
    for line in text.lines() {
        ...
        match event_type {
            ...
            "assistant/message" => {
                ...
                // which is the granularity a houhub bubble already has.
            ...
            //
            // The LOG is the only place houhub can see this. On the wire the
...
mod tests {
    ...
    fn resolve_home_prefers_env_override() {
        ...
        // `DSH_HOME=~/custom` names the same directory for houhub as for the
    ...
    fn only_canonical_generation_names_are_selected() {
        ...
        // houhub's integer cannot hold would stop being a generation, and a
