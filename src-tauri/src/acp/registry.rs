...
pub fn get_agent_meta(agent_type: AgentType) -> AcpAgentMeta {
    ...
    match agent_type {
        AgentType::ClaudeCode => AcpAgentMeta {
            ...
            // Houhub already shipped 0.59.0; keep the release line monotonic.
        ...
        AgentType::Codex => AcpAgentMeta {
            ...
            // codex-acp drives `codex app-server`; since 1.0.1 it resolves the resumed
...
mod tests {
    ...
    fn registry_pins_current_acp_agent_versions() {
        ...
        assert_npx_version(AgentType::Cline, "3.0.42", "cline@3.0.42", Some("22.0.0"));
        assert_npx_version(
            AgentType::CodeBuddy,
            "2.123.1",
