...
fn merge_agent_env(
    ...
    if let Some(dir) = crate::commands::office_tools::officecli_agent_path_dir() {
        ...
        merged.insert(path_key, prepend_path_value(current, [dir]));
    }
