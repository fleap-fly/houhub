...
/// Per-agent defaults applied when houhub-mcp spawns a subagent on behalf of a
...
///
/// `parent_connection_id` is the houhub-internal ACP connection UUID for the
...
pub enum DelegationError {
    ...
    /// read "unrecognized stop reason" for a reason HouHub recognizes perfectly
