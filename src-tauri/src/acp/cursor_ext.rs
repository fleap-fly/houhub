...
//! not found`, which is what houhub used to send — and what made a live Cursor
...
/// `multiSelect`. Counts are clamped to houhub's card bounds the same way
...
/// optional there — and it means "the list the client now holds". HouHub keeps
