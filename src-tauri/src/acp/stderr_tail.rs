...
//!
//! When an agent reports `EndTurn` without producing any output, houhub
...
//! and what houhub failed to parse. This module owns the collection of that
//! evidence.
//!
...
/// Identifiers from houhub's own ACP schema that are safe to echo back.
///
