    ...
    match &envelope.payload {
        ...
        AcpEvent::SessionStarted { session_id } => {
            ...
            if let Some(cid) = conversation_id {
                ...
                // history hangs off. See houhub#500.
...
///   hosts copy the MCP method verbatim (`mcp__houhub-mcp__delegate_to_agent`),
...
async fn register_delegation_tool_call_from_event(
    ...
    // `meta["houhub.delegation"]` write and the historical
...
mod delegation_title_tests {
    ...
    fn matches_mcp_prefixed_method_in_title() {
        ...
        assert!(is_delegation_invocation(
            "Run mcp__houhub__delegate_to_agent",
            None
        ));
    }
...
mod delegation_registration_tests {
    ...
    async fn update_backfills_key_onto_unkeyed_tool_call() {
        ...
        register_delegation_tool_call_from_event(
            &b,
            &tool_call_event("tc-2", "mcp__houhub-mcp__delegate_to_agent", None),
        )
        .await;
    ...
    async fn cursor_args_wrapper_yields_keyed_registration() {
        ...
        register_delegation_tool_call_from_event(
            ...
            &tool_call_event(
                ...
                Some(
                    r#"{"providerIdentifier":"houhub-mcp","toolName":"delegate_to_agent","args":{"agent_type":"codex","task":"build it"}}"#,
                ),
            ),
        )
        .await;
