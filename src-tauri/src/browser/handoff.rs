...
pub const PICKER_GLOBAL: &str = "__houhubPicker";
...
mod tests {
    ...
    fn the_picker_script_is_self_contained() {
        assert!(PICKER_JS.contains("houhubBrowserPicker"));
