...
/// WebSocket subprotocol both ends name, next to houhub's token protocol.
pub const TUNNEL_PROTOCOL: &str = "houhub-tunnel";

/// Where the tunnel is served, relative to the houhub-server's base URL.
