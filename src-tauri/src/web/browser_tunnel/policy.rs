...
//!
//! The tunnel sits behind houhub's token, and that token already runs
...
//! here. `HOUHUB_BROWSER_TUNNEL=private` narrows it to this host and the
...
pub const ENV_VAR: &str = "HOUHUB_BROWSER_TUNNEL";
