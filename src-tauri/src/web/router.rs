...
pub fn build_router(
    ...
    let api = Router::new()
        ...
        .route(
            "/get_houhub_mcp_service_status",
            post(handlers::mcp_service::get_houhub_mcp_service_status),
        )
        .route(
            "/start_houhub_mcp_service",
            post(handlers::mcp_service::start_houhub_mcp_service),
        )
        .route(
            "/set_houhub_mcp_tool_group",
            post(handlers::mcp_service::set_houhub_mcp_tool_group),
        )
        .route(
        ...
        //
        // Issue #179: when houhub runs in server mode the user has no
        ...
        .route(
            ...
            post(handlers::houflow::houflow_connector_status),
        )
        .route(
            "/houflow_connector_login",
            post(handlers::houflow::houflow_connector_login),
        )
        .route(
            "/houflow_connector_up",
            post(handlers::houflow::houflow_connector_up),
        )
        .route(
            "/houflow_connector_down",
            post(handlers::houflow::houflow_connector_down),
        )
        .route(
            "/houflow_connector_heartbeat",
            post(handlers::houflow::houflow_connector_heartbeat),
        )
        .route(
            "/houflow_connector_autostart",
            post(handlers::houflow::houflow_connector_autostart),
        )
        .route(
            "/houflow_connector_logs",
            post(handlers::houflow::houflow_connector_logs),
        )
        .route(
            "/houflow_connector_commands",
            post(handlers::houflow::houflow_connector_commands),
        )
        .route(
            "/houflow_connector_sync_local_agents",
            post(handlers::houflow::houflow_connector_sync_local_agents),
        )
        // ─── Workbench (Project System cloud space) ───
        .route(
            "/workbench_begin_device_auth",
            post(handlers::workbench::workbench_begin_device_auth),
        )
        .route(
            "/workbench_poll_device_auth",
            post(handlers::workbench::workbench_poll_device_auth),
        )
        .route(
        ...
        .route(
            ...
            post(handlers::workbench::workbench_set_active_project),
        )
        .route(
            "/workbench_sign_out",
            post(handlers::workbench::workbench_sign_out),
        )
        .route(
            "/workbench_space_list",
            post(handlers::workbench::workbench_space_list),
        )
        .route(
            "/workbench_space_usage",
            post(handlers::workbench::workbench_space_usage),
        )
        .route(
            "/workbench_space_download_url",
            post(handlers::workbench::workbench_space_download_url),
        )
        .route(
            "/workbench_space_create_folder",
            post(handlers::workbench::workbench_space_create_folder),
        )
        .route(
            "/workbench_space_presign_upload",
            post(handlers::workbench::workbench_space_presign_upload),
        )
        .route(
            "/workbench_space_complete_upload",
            post(handlers::workbench::workbench_space_complete_upload),
        )
        .route(
