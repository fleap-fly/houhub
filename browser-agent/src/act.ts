 ...
 * `__houhubAgent`, and the reason refs exist at all.
 *
...
function obstructionAt(x: number, y: number, target: Element): Element | null {
  ...
  // `__houhubAgent` out of the page's reach, read from the other side.
 ...
 * every engine houhub ships on has them, and a throw from in here would come
