 ...
 * any value other than `"0"` ⇒ enabled (default on): when HouHub connects pi to a
 ...
 * HouHub's own launch path (never the child). These persist through the same
...
export function PiConfigPanel({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Workspace trust — auto-trust the folder HouHub launches pi into */}
