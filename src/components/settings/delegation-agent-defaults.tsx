 ...
 *      chat-side `selectorsCache`. What the user sees here is what houhub-mcp
...
// collide with any real option id any agent could emit — the houhub
// prefix makes a collision implausible.
const DEFAULT_SENTINEL = "__houhub_default__"
...
export function DelegationAgentDefaultsPanel({
  ...
  // Custom ACP agents are delegation targets too (houhub-mcp advertises them
