...
/** The copy-pasteable login command. A houhub-managed `qoder` lives in the
 ...
 * keeps houhub out of the way of the file's other writers — Qoder's own
 * `/settings` dialog, houhub's MCP settings page (owner of the top-level
