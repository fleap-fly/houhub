 ...
 * them are injected by `houhub-mcp` when an agent starts, so what the user is
 ...
 * with the status-bar houhub-mcp popover — the two lists are the same switches
 ...
 *  comes from `lib/agent-tool-groups`, which the status-bar houhub-mcp popover
...
export function AgentToolsSettingsSection() {
   ...
   *
   * The status-bar houhub-mcp popover carries the same two switches, and the
