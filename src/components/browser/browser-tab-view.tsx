 ...
 * dev server on the houhub host through the port bridge instead.
 */
export function BrowserTabView({ tab }: { tab: BrowserWorkspaceTab }) {
  if (!isDesktop()) return <BrowserBridgeView tab={tab} />
  // An address of the remote houhub host: loaded through that host, or not
...
/**
 * A tab of the remote houhub host. Its page is shown here and fetched from
