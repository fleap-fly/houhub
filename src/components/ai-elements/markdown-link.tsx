...
export function MarkdownLink({
  ...
  // A houhub:// reference link renders as an inline badge, mirroring the
  // composer's reference chips: session / commit / agent links, plus the inert
  // `houhub://embedded/…` badge a path-less pasted attachment serializes to (its
  ...
  // text is the label.
  if (href.toLowerCase().startsWith("houhub:")) {
