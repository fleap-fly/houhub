...
// The same links survive as in MessageResponse: `houhub://` references keep
// their href through sanitize (rehype-allow-houhub), which would otherwise leave
...
const rehypePlugins = rehypePluginsAllowingHouhub(
