 ...
 * `HouhubMcpToolCard`, which states the refusal reason.
 */
...
import { parseHouhubMcpToolCall } from "@/lib/houhub-mcp-tool"
...
export function ResumedDelegationCard({
  ...
  // reason, the single thing the user has to read. `HouhubMcpToolCard` states
  // it plainly.
