...
import { isHouhubMcpWorkbenchTool } from "@/lib/houhub-mcp-tool"
...
const ToolCallPart = memo(function ToolCallPart({
  ...
  // houhub-mcp ask_user_question: render the asked question(s) and the user's
  ...
  // houhub-mcp check_user_feedback: render the received steering notes as a
  ...
  if (isHouhubMcpWorkbenchTool(toolNameLower)) {
    return (
      <HouhubMcpToolCard
        tool={toolNameLower}
        input={part.input ?? null}
