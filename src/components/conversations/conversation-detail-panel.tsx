...
const ConversationTabView = memo(function ConversationTabView({
  ...
  // An agent can run a turn HOUHUB never started: CodeBuddy drains a finished
  ...
  // The docked composer is the only place a quote can land. Keep the quote
  // action hidden while the welcome state or a load error has removed it.
  ...
  const messageListNode = (
    <GoalControlProvider value={goalControlValue}>
      <MessageListView
        ...
        // Asking opens a separate conversation, so it remains available even
        // when this tab's composer is unavailable, provided its workspace can
        // be identified.
