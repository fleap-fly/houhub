        ...
        {showBranchPicker && ownFolder && (
          <BranchPicker
            ...
            onCheckout={async (branchName, isRemote) => {
              // Route through the shared switch logic so worktree branches
              // navigate to their folder and root branches check out in the
              // correct root, for both draft and existing conversations.
