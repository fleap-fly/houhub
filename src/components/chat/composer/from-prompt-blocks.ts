...
import { parseHouhubReferenceUri as parseReferenceUri } from "./reference-uri"
 ...
 *   queue-edit.
 * - `resource_link` blocks whose uri is a composer scheme (`file:` / `houhub:`)
...
// The reference uri grammar (file:/houhub: → ReferenceAttrs) now lives in
