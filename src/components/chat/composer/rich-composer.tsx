    ...
    const editor = useEditor({
      ...
      editorProps: {
        attributes: {
          ...
          class: "houhub-composer-content grow",
          role: "textbox",
          "aria-multiline": "true",
    ...
    return (
      ...
      >
        {/* `grow` (a CONTENT flex basis), never `flex-1` (a ZERO basis). The
            ...
            `houhub-composer-content` class) also makes the contenteditable
        ...
        <EditorContent
          editor={editor}
          className="houhub-composer-scroll flex min-h-0 grow flex-col overflow-y-auto px-3 py-2 text-base md:text-sm"
        />
