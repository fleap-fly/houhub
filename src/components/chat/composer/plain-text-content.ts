 ...
 * `[label](file:·houhub:…)` links and bare `/cmd`·`$skill` tokens) becomes
 ...
 * regardless; they carry a `file:`/`houhub:` destination and were deliberately
 * inserted.
 */
 ...
 * `[label](file:·houhub:…)` links and bare `/cmd`·`$skill` tokens must show as
 ...
 *   (`[label](file:·houhub:…)` links, `/cmd`·`$skill` tokens). Left to
