...
// embedded badge still in the document. The `houhub://` scheme is never a real
...
export function MessageInput({
  ...
  // mutates afterwards. A desktop window bound to a remote houhub-server
          ...
          <ContextMenuTrigger asChild disabled={!clipboardReadSupported}>
            <div
              ...
              className={cn(
                ...
                "houhub-composer-chrome @container relative flex flex-col rounded-xl border border-input bg-transparent transition-colors",
