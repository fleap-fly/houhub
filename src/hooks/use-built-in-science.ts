...
// fetch. Science skills are bundled into the binary and change only when HouHub
...
/**
 * Returns the list of built-in scientific-research skills bundled into HouHub.
 *
