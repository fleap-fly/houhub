...
export const MONACO_LIGHT_THEME = "houhub-light"
export const MONACO_DARK_THEME = "houhub-dark"
...
// HouHub renders files from arbitrary projects but never loads their build
