...
/** What happens when a server houhub started announces its address.
 *
...
export interface BrowserPrefsSnapshot {
  ...
  /** What to do when a server started in a houhub terminal (or in a terminal
   *  an agent asked houhub to run) prints its loopback address.
   *
...
const CHANGE_EVENT = "houhub:browser-prefs-changed"
