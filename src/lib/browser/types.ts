 ...
 *  guest (`houhub-doc:`), which the file column hosts in place of the inline
 *  HTML preview. */
...
export interface BrowserCapabilities {
   ...
   *  surface with a handler for `houhub-doc:`). */
  docGuest: boolean
   ...
   *  houhub-server: a profile of their own to proxy (macOS 14+), and on macOS
...
/** A loopback address something houhub started printed, and that answered a
