 ...
 */
export const STORAGE_KEY_THEME_COLOR = "houhub-theme-color"
export const STORAGE_KEY_ZOOM_LEVEL = "houhub-zoom-level"
...
export const STORAGE_KEY_UI_FONT = "houhub-ui-font"
export const STORAGE_KEY_UI_FONT_CUSTOM = "houhub-ui-font-custom"
export const STORAGE_KEY_UI_FONT_STACK = "houhub-ui-font-stack"
export const STORAGE_KEY_EDITOR_FONT = "houhub-editor-font"
export const STORAGE_KEY_EDITOR_FONT_CUSTOM = "houhub-editor-font-custom"
export const STORAGE_KEY_EDITOR_FONT_SIZE = "houhub-editor-font-size"
export const STORAGE_KEY_EDITOR_LIGATURES = "houhub-editor-ligatures"
export const STORAGE_KEY_EDITOR_WORD_WRAP = "houhub-editor-word-wrap"
export const STORAGE_KEY_WELCOME_QUICK_ACTIONS = "houhub-welcome-quick-actions"
export const STORAGE_KEY_TERMINAL_FONT = "houhub-terminal-font"
export const STORAGE_KEY_TERMINAL_FONT_CUSTOM = "houhub-terminal-font-custom"
...
export const STORAGE_KEY_CUSTOM_THEME = "houhub-custom-theme"
export const STORAGE_KEY_CUSTOM_THEME_ENABLED = "houhub-custom-theme-enabled"
export const STORAGE_KEY_CUSTOM_CSS = "houhub-custom-css"
export const STORAGE_KEY_CUSTOM_CSS_ENABLED = "houhub-custom-css-enabled"
export const STORAGE_KEY_CUSTOM_STYLE_SUSPENDED =
  "houhub-custom-style-suspended"
...
(function() {
  try {
    ...
    // stack 只是「显式选择」的缓存，不是偏好本身：仅当存在显式 id（houhub-ui-font）
