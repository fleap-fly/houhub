...
/**
 * How HouHub's own tool groups are named and drawn, in one table.
 *
 * Two surfaces render this list: the houhub-mcp popover in the bottom-right of
...
export interface AgentToolGroupPresentation {
   ...
   *  sends the same relation on the wire (`HouHubMcpToolGroup.requires`); this
