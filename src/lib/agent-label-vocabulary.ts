 ...
 * agent as already-rendered display strings, and houhub shows them verbatim —
 ...
 * nothing), so an English — or Japanese, or German — houhub renders Chinese
 ...
 *   is upstream behaviour, not a string houhub renders.
 */
