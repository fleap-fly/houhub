...
function inferFromInput(
  ...
  // (plural) is the houhub-mcp `ask_user_question` payload shape, so the live
...
export function normalizeToolName(toolName: string): string {
  ...
  // houhub-mcp live-feedback poll. Same host-prefix story as the delegation tools
...
export function inferLiveToolName(params: {
  ...
  if (
    ...
    "houhub.delegation" in params.meta
  ) {
