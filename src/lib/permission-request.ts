...
export function parsePermissionToolCall(
  ...
  // command view cannot approve a command it was never shown. houhub has that
  ...
  // still ships it (as `toolCall.content`, since houhub advertises no
  ...
  // governs what houhub INSTALLS, while `resolve_npx_command` launches whatever
