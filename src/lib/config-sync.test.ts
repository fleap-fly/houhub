...
const createObjectURL = vi.fn(() => "blob:houhub/1")
...
describe("defaultExportFileName", () => {
  it("is filesystem-safe and sorts chronologically", () => {
    ...
    expect(name).toBe(
      `houhub-config-2026-05-04-11-32-07.${CONFIG_EXPORT_EXTENSION}`
    )
