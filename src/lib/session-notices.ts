 ...
 * (running / done with the token delta / failed with the reason), which houhub
 ...
 *   compaction frames to a client WITHOUT the capability. houhub always has it,
...
/** A level houhub cannot grade renders as `info`, the gentlest one. */
