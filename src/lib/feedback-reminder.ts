 ...
 *
 *  1. Strip anchor. The runtime keeps no separate copy of a sent prompt, so on
 *     reload the user turn is reparsed from the agent's own session file — the reminder rides
 ...
 *     block as a HouHub system note rather than the user's own prose.
 *
 ...
 */
export const FEEDBACK_REMINDER_SENTINEL = "⟦houhub:live-feedback⟧"
