 ...
 * strings houhub does not choose, and a plain object inherits `Object.prototype`
...
const STORAGE_KEY = "houhub:model-labels"
 ...
 *
 * localStorage is shared with every other houhub instance on this machine and
