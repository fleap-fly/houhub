...
export const LANGUAGE_SETTINGS_STORAGE_KEY = "houhub.system_language_settings"
export const LANGUAGE_MODE_COOKIE_KEY = "houhub.language_mode"
export const LANGUAGE_COOKIE_KEY = "houhub.locale"
